...
/**
 * Provides a callback when {@link com.bullmobi.message.ui.activities.EasyNotificationActivity}
...
public abstract class ActiveModeSensor {
    ...
    /**
     * Provides a callback when EasyNotification should be shown / hidden.
     *
     * @author Artem Chepurnoy
     */
    public interface Callback {
        ...
        /**
         * Requests to show the EasyNotification.
         */
