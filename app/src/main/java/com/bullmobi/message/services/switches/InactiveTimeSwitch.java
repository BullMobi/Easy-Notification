...
import com.bullmobi.message.InactiveTimeHelper;
...
/**
 * Prevents {@link com.bullmobi.message.services.activemode.ActiveModeService} from listening to
 * sensors on inactive time (if corresponding option is enabled.)
 *
 * @author Artem Chepurnoy
 * @see com.bullmobi.message.ui.fragments.settings.MoreSettings
 */
