 ...
 * MA  02110-1301, USA.
 */
package com.bullmobi.message.ui.fragments;
...
import com.bullmobi.message.compat.SceneCompat;
...
import com.bullmobi.message.services.media.MediaController2;
import com.bullmobi.message.services.media.Metadata;
import com.bullmobi.message.ui.DynamicBackground;
import com.bullmobi.message.ui.activities.EasyNotificationActivity;
import com.bullmobi.message.ui.components.ClockWidget;
import com.bullmobi.message.ui.components.MediaWidget;
import com.bullmobi.message.ui.components.NotifyWidget;
import com.bullmobi.message.ui.components.Widget;
import com.bullmobi.message.ui.view.ForwardingLayout;
import com.bullmobi.message.ui.view.ForwardingListener;
import com.bullmobi.message.ui.widgets.CircleView;
...
import com.bullmobi.base.ui.widgets.TextView;
import com.bullmobi.base.utils.FloatProperty;
import com.bullmobi.base.utils.MathUtils;
...
public class EasyNotificationFragment extends Fragment implements
    ...
    private static final String TAG = "EasyNotificationFragment";

    private static final int MSG_SHOW_HOME_WIDGET = 0;
    private static final int MSG_HIDE_MEDIA_WIDGET = 1;

    private static final Property<EasyNotificationFragment, Float> TRANSFORM =
            new FloatProperty<EasyNotificationFragment>("populateStdAnimation") {

                private float mValue;

                @Override
                public void setValue(EasyNotificationFragment fragment, float value) {
                    fragment.populateStdAnimation(mValue = value);
                }

                @Override
                public Float get(EasyNotificationFragment fragment) {
                    return mValue;
                }
    ...
    private EasyNotificationActivity mActivityAcd;
     ...
     * @see com.bullmobi.message.ui.activities.KeyguardActivity
     */
    ...
    public void onAttach(Activity activity) {
        ...
        mActivityAcd = isNotDemo() ? (EasyNotificationActivity) activity : null;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(isNotDemo()
                ? R.layout.easynotification_fragment_full
                : R.layout.easynotification_fragment, container, false);
        assert root != null;
     ...
     * {@link com.bullmobi.message.Config#getIconSizePx() set} in config.
     */
    ...
    /**
     * @see #showWidget(com.bullmobi.message.ui.components.Widget, boolean)
     */
     ...
     * @see com.bullmobi.base.utils.power.PowerSaveDetector
     */
    ...
    /**
     * @return {@code true} if this fragment is attached to {@link com.bullmobi.message.ui.activities.EasyNotificationActivity} and
     * matches parent layout, {@code false} if this is only preview.
     */
    public boolean isNotDemo() {
        return getActivity() instanceof EasyNotificationActivity;
    }
    ...
    private static class H extends WeakHandler<EasyNotificationFragment> {

        public H(@NonNull EasyNotificationFragment fragment) {
            super(fragment);
        }

        @Override
        protected void onHandleMassage(@NonNull EasyNotificationFragment fragment, Message msg) {
            switch (msg.what) {
