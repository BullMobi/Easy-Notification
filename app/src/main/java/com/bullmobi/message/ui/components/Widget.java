...
/**
 * Base of EasyNotification's widgets.
 *
...
public abstract class Widget {
    ...
    @NonNull
    private final EasyNotificationFragment mFragment;
    ...
    public Widget(@NonNull Callback callback, @NonNull EasyNotificationFragment fragment) {
        mCallback = callback;
        mFragment = fragment;
    }
     ...
     */
    @NonNull
    public EasyNotificationFragment getFragment() {
        return mFragment;
    }
