 ...
 * MA  02110-1301, USA.
 */
package com.bullmobi.message.blacklist;
...
import com.bullmobi.base.content.SharedList;
...
public final class Blacklist extends SharedList<AppConfig, AppConfig.Saver> {
    ...
    /**
     * This is called on {@link com.bullmobi.message.App#onCreate() App create}.
     *
     * @see com.bullmobi.base.content.SharedList#init(android.content.Context)
     */
    @Override
    ...
    /**
     * <b>Creates</b> new instance of {@link com.bullmobi.message.blacklist.AppConfig} and
