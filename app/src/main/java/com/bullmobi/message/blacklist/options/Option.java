 ...
 * MA  02110-1301, USA.
 */
package com.bullmobi.message.blacklist.options;
...
public abstract class Option extends Blacklist.OnBlacklistChangedListener implements
     ...
     * @see com.bullmobi.message.blacklist.AppConfig#DIFF_HIDDEN
     * @see com.bullmobi.message.blacklist.AppConfig#DIFF_RESTRICTED
     * @see com.bullmobi.message.blacklist.AppConfig#DIFF_NON_CLEARABLE
     */
