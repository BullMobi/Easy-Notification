 ...
 * MA  02110-1301, USA.
 */
package com.bullmobi.message.plugins.xposed;
...
public class ImmersiveModeDontPanic implements IXposedHookZygoteInit {
    ...
    public void initZygote(StartupParam startupParam) throws Throwable {
        if (Device.hasLollipopApi()) {
            ...
            // not only about EasyNotification.
            ...
            XC_MethodHook hook = new XC_MethodHook() {
                ...
                protected void beforeHookedMethod(XC_MethodHook.MethodHookParam param) throws Throwable {
                    ...
                    if (pkg != null && pkg.startsWith("com.bullmobi.message")) {
                        param.setResult(null);

                        Log.i(TAG, "An unconfirmation of EasyNotification\'s immersive mode passed to hell.");
                    }
                }
            };
