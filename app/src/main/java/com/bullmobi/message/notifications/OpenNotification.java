 ...
 * MA  02110-1301, USA.
 */
package com.bullmobi.message.notifications;
...
import com.bullmobi.message.utils.BitmapUtils;
import com.bullmobi.base.Device;
import com.bullmobi.base.async.AsyncTask;
...
public abstract class OpenNotification implements
     ...
     *
     * @see com.bullmobi.message.notifications.OpenNotification.OnNotificationDataChangedListener
     * @see #registerListener(com.bullmobi.message.notifications.OpenNotification.OnNotificationDataChangedListener)
     */
     ...
     * used by {@link com.bullmobi.message.ui.fragments.EasyNotificationFragment}.
     *
     * @see #clearBackground()
     */
