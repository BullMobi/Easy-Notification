...
import static com.bullmobi.message.graphics.BackgroundFactory.generate;

/**
 * Simple single-thread background factory.
 *
 * @author Artem Chepurnoy
 * @see com.bullmobi.message.graphics.BackgroundFactory
 * @see com.bullmobi.message.notifications.IconFactory
 */
