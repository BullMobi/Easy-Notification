 ...
 * MA  02110-1301, USA.
 */
package com.bullmobi.snake.snake;
...
import com.bullmobi.snake.Logic;
import com.bullmobi.snake.Surface;
...
public abstract class GameObject {
    ...
    public static class Node extends Drawable {
         ...
         * by {@link #reparent(com.bullmobi.snake.snake.GameObject.Node) reparenting}
         * or simple {@link #kill() killing}.
         * @see com.bullmobi.snake.snake.GameObject
         * @see com.bullmobi.snake.snake.Animal
         * @see com.bullmobi.snake.Logic
         * @see #isMeal()
         */
        public boolean isPredator() {
            return isPredator;
         ...
         * {@link #reparent(com.bullmobi.snake.snake.GameObject.Node) eated}
         * or no.
         */
        public boolean isMeal() {
            return isMeal;
