...
for i in range(1, 5):
    try:
        url = 'https://crowdin.net/download/project/easynotification.zip'
...
if VALIDATE_LOCALES:
    ...
    # > String.format("Hello %1$s! My name is %2$s.", "world", "EasyNotification")
    # Hello world! My name is EasyNotification.
